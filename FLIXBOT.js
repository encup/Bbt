...
let audio = {
    ...
    contextInfo: {
      externalAdReply: {
        ...
        body: 'SALAM',
        sourceUrl: '',
        thumbnail: await (await Fernazerini.getFile('https://telegra.ph/file/14be4b5b08e07a9dfb739.jpg')).data,
  ...
  let verif = {
            ...
            message: {
                conversation: `_YASSxOFC Terverifikasi Oleh WhatsApp_`
            }
        }
...
console.log('\x1b[1;31m~\x1b[1;37m>', '[\x1b[1;32m GanyuAI \x1b[1;37m]', time, chalk.green(budy || m.mtype), 'Dari', chalk.blue(pushname), 'Di', chalk.yellow(groupName ? groupName : 'Private Chat' ), 'args :', chalk.white(args.length))
            }
...
case 'socialmedia': 
    ...
    [
        ...
        botname, // Footer message
        'Visit', // Button display text
        'http://t.me/YASSxOFC', // Command (URL in this case)
        'cta_url', // Button type
        'http://t.me/YASSxOFC' // URL (used in image generation)
    ], 
    [
...
"showAdAttribution": true,
"renderLargerThumbnail": true,
"title": Styles(`ʏᴀꜱꜱxᴏꜰᴄ`), 
"containsAutoReply": true,
"mediaType": 1, 
"jpegThumbnail": fs.readFileSync("./Inimedia/image/Fernazerini.jpg"),
"mediaUrl": `https://telegra.ph/file/14be4b5b08e07a9dfb739.jpg`,
...
anyone like it? please upgrade Premium User to owner`
  Fernazerini.sendMessage(from, { image: { url: "https://telegra.ph/file/14be4b5b08e07a9dfb739.jpg" }, caption: teks28 }, { quoted: fcall })
}
...
break
case 'sewa': case 'bot': case 'sewabot': case 'Ganyu': {
reply(` List Sewa GANYU AI 
  • Permanen [ 20K ]
  • 4Hari [ 3K ]
  • 7Hari [ 5K ]
  • 10Hari [ 7K ]
...
Jika Ingin Menyewa GANYU AI Silahkan Ketik .pembayaran 
`)
}
break
case 'delprem': {
...
reply('GANYU AI SUKSES MODE PUBLIC')
}
break
case 'self': {
if (!isCreator) return mess.owner
Fernazerini.public = false
reply('GANYU AI SUCCES MODE SELF')
}
break
//================ D O W N L O A D ==================//
...
"mediaType": 1,
"sourceUrl": '',
"thumbnailUrl": 'https://telegra.ph/file/14be4b5b08e07a9dfb739.jpg',
"renderLargerThumbnail": true
}
}}, {quoted: fcall})
...
let teks = m.quoted ? quoted.text : text
 try {
   try {
                    ...
                    pic = 'https://telegra.ph/file/14be4b5b08e07a9dfb739.jpg'
                }
         const obj = {
            "type": "quote",
            "format": "png",
...
Done Bwang Kuhhh Kamu Sekarang Sudah Bisa Mengakses GANYU AI Abangkuhh Btw Limit Gada Reset Reset an Jika Limit Habis Silahkan Buy Limit Di YASSxOFC`
veri = m?.sender
if (!m.isGroup) {
...
akunlo = "https://telegra.ph/file/14be4b5b08e07a9dfb739.jpg" 
if (!u) return
...
let msg = generateWAMessageFromContent(m.chat, {
 ...
 title: `ʙᴜʏ ᴘᴀɴᴇʟ ʀᴇᴋ`,
 subtitle: "dcdXdino",
 hasMediaAttachment: true,...(await prepareWAMessageMedia({ image: { url: "https://telegra.ph/file/14be4b5b08e07a9dfb739.jpg" } }, { upload: Fernazerini.waUploadToServer }))
 }),
 nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.create({
 buttons: [ 
 {
...
case 'tutorial': {
await loading()
tut = `ᴛᴜᴛᴏʀ ʀᴜɴ ᴘᴀɴᴇʟ ʙʏ ʏᴀꜱꜱxᴏꜰᴄ
...
case 'backup':
        {
          if (!isCreator) return reply(mess.owner)
     await reply("ᴡᴀɪᴛ ʙᴀᴄᴋᴜᴘ sᴄ Ganyu ᴠ4.5");
...
𝗧𝗲𝗿𝗶𝗺𝗮𝗸𝗮𝘀𝗶𝗵 𝗧𝗲𝗹𝗮𝗵 𝗢𝗿𝗱𝗲𝗿 𝗗𝗶 𝙔𝘼𝙎𝙎𝙓𝙊𝙁𝘾
...
Itulah Rules GANYU AI Kak Jangan Langgar Ya Kak`)
             await Fernazerini.sendMessage(m.chat, {audio: fs.readFileSync('./Vn/rulesy.mp3'),mimetype: 'audio/mpeg',ptt: true}, {quoted:m})}
             break
             case 'formatneed': {
             reply(`*FORMAT NEED AKUN BY 𝙔𝘼𝙎𝙎𝙓𝙊𝙁𝘾*
_NOTE!!! : INI BUKAN 100% AKUN MILIK ADMIN ATAU 𝙔𝘼𝙎𝙎𝙓𝙊𝙁𝘾 TETAPI AKUN MILIK SELER!!!_
...
_JANGAN LUPA SLALU MENGGUNAKAN JASA ADMIN 𝙔𝘼𝙎𝙎𝙓𝙊𝙁𝘾 AGAR TERHINDAR DARI PENIPUAN ATAU MODUS LAINNY_`)
}
break
case 'formatjp': {
reply(`*FORMAT JASA PSOT AKUN BY 𝙔𝘼𝙎𝙎𝙓𝙊𝙁𝘾*
...
break
case 'feerekber': {
reply(`ALL FEE REKBER DI 𝙔𝘼𝙎𝙎𝙓𝙊𝙁𝘾 HANYA 5K`)
}
break
case 'feegc': {
reply(`langsung culik 𝙔𝘼𝙎𝙎𝙓𝙊𝙁𝘾`)
}
break
case 'donasi': {
teks28 = `*『 DONASI 』*
Terimakasih Telah Berdonasi Kak 𝙔𝘼𝙎𝙎𝙓𝙊𝙁𝘾 akan Terus Mengembangkan Bot ini Insyaallah
...
if (!isAdmins) return m.reply('ᴋʜᴜsᴜs ᴀᴅᴍɪɴ ɢʀᴏup')
                ...
                case 'invite': {
	if (!m.isGroup) return reply(`khusus group`)
	if (!isBotAdmins) return reply(`Ganyu belum admin`)
...
Fernazerini.sendMessage(m.sender, { image: { url: yeha }, caption : '© GANYU AI 2023 - 2024'}, { quoted: m })
}
break
case 'tiktokgirl':
await loading()
...
if (!m.isGroup) return reply(`Khusus Group`)
if (!isAdmins) return reply(`Khusus admin`)
if (!isBotAdmins) return reply(`Jadikan Ganyu Admin Dulu`)
